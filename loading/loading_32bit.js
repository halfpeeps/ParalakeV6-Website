var imageFolder = "loading/bg_images/";
...
function showImage(index) {
  ...
  nextBG.className = "background-rotate active";
  currentBG.className = "background-rotate";

  authorLabel.innerHTML = img.author;
...
var tips = [
    ...
    { title: "GAMEPLAY TIP", description: "You can apply for the Police Department at plpd.online/joinus." },
    ...
    { title: "GAMEPLAY TIP", description: "There are 9 different locations around the map where the drug dealer can be, who moves every few hours." },
    ...
    { title: "GAMEPLAY TIP", description: "You can get a full list of cars and their details at paralakecars.club" },
    ...
    { title: "GAMEPLAY TIP", description: "If you believe an officer acted unlawfully, make a complaint with evidence on plpd.online/complain" },
    ...
    { title: "GAMEPLAY TIP", description: "Use the overpass or monorail instead of walking on the highway!" },
    ...
    { title: "GAMEPLAY TIP", description: "Before selling your car make sure to downgrade and sell any upgrades at Veikko Station." },
    { title: "GAMEPLAY TIP", description: "Fish at Beach to avoid getting mugged." },
    ...
    { title: "GAMEPLAY TIP", description: "When buying clothes at Jennifers make sure to ask about Fashion tips." },
    ...
    { title: "GAMEPLAY TIP", description: "You can view the places where you are allowed to mug using the Mugging Map at https://help.perpheads.com/page/mugging-map." },
    ...
    { title: "GAMEPLAY TIP", description: "To reclaim your stolen planters, speak to the City Hall Library NPC." },
    ...
    { title: "GAMEPLAY TIP", description: "Don't step on the Monorail tracks or they will electrify you." },
...
function showNextTip() {
  tipTitle.innerHTML = tips[currentTip].title;
  tipText.innerHTML = tips[currentTip].description;
